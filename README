...
3. Expand the Task Scheduler Library on the left-hand side. You can create the task in the root of this folder or, as I would recommend, create your own folder and create the task in there.
...
7. **Actions**
    ...
    3. Use **-File C:\Users\Username\windows-sunset-theme-switcher.ps1 -Latitude 0.0 -Longitude 0.0** in the arguments field. *NOTE: Replace the path with the script path you chose in Step 1. Replace the Latitude and Longitude arguments with your latitude and longitude.
8. **Conditions**
